...
public class FileDownload extends HttpServlet { //javax.servlet.http. 를 import해도 가능
  ...
  protected void doProcess(HttpServletRequest request,          //get이든 post이든 이 함수가 실행되게 되어있다
